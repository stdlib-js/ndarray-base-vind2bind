...
```javascript
vind2bind = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-vind2bind@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-vind2bind@umd/bundle.js"></script>
```
