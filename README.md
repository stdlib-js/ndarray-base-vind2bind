...
```javascript
vind2bind = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-vind2bind@v0.2.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/ndarray-base-vind2bind/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/ndarray-base-vind2bind/actions/workflows/test.yml?query=branch:v0.2.1
